...
Requires **React 17**, **18**, or **19**, **react-dom** with the same range, and **semantic-ui-react ^2.1.3**. The published bundle is built with [React Compiler](https://react.dev/reference/react-compiler/compiling-libraries) (`target: '17'`). See [CHANGELOG.md](./CHANGELOG.md) for peer dependency changes in 0.7.0.
